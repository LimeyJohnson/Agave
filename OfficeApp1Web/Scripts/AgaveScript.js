...
OfficeApp1Script.AgaveScript.getTableBinding=function(){var $0=$('#BindingField').val()+OfficeApp1Script.AgaveScript.tableBindingSuffix;Office.select('bindings#'+$0).getDataAsync(OfficeApp1Script.AgaveScript.$0(Office.CoercionType.Matrix),function($p1_0){
alert('Break point');});}
...
if($p1_0.status===Office.AsyncResultStatus.Succeeded){var $1_0=$('#results');$1_0.html('');var $1_1=$p1_0.value[1];$.each($1_1,function($p2_0,$p2_1){
...
OfficeApp1Script.AgaveScript.setError=function(errorText){$('#error').val(errorText);}
