...
OfficeApp1Script.AgaveScript.setBinding(OfficeApp1Script.AgaveScript.rowBinding,Office.BindingType.Matrix);OfficeApp1Script.AgaveScript.populateRowCombo();OfficeApp1Script.AgaveScript.select(OfficeApp1Script.AgaveScript.rowBinding).addHandlerAsync(Office.EventType.BindingDataChanged,function($p2_0){
$('#eventResults').append('Event fired: '+$p2_0.binding.id+' Type: '+$p2_0.type.toString());});};})();
