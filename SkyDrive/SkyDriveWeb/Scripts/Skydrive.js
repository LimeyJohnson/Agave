    ...
    if (!window.WL) {
        ...
        */
        ...
        WL.init = function (properties) {
            ...
            /// to this URI during the OAuth flow. The redirect_uri value must match the redirect domain of the app registered at
            /// https://manage.dev.live.com/ site.
        ...
        (function () {
                ...
                _normalizeResp: function () {
                    var op = this,
                        ...
                        updateSelectedItem = function (item) {
                            ...
                            if (uploadLocation) {
                                item.upload_location = uploadLocation.replace("WL_APISERVICE_URL", WL_APISERVICE_URL);
                            }
                        };
            ...
            function buildPickerUrl(props) {
                ...
                return appendUrlParameters(WL_SKYDRIVE_URL, params);
            }
        ...
        UploadOperation.prototype._getStrategy = function (properties) {
            ...
            // if the input element has a files property, then the browser supports the file API
            // and will we use that.
            if (element.files) {
        ...
        var WL_OAUTH_HOST = "login.live.com";

        wl_app[API_X_HTTP_LIVE_LIBRARY] = "Web/DEVICE_" + trimVersionBuildNumber("5.3.3497.0313");

        var WL_APISERVICE_URL = "https://apis.live.net/v5.0/",
            WL_SKYDRIVE_URL = "https://skydrive.live.com/";
        wl_app[WL_SDK_ROOT] = "//js.live.net/v5.0/";
