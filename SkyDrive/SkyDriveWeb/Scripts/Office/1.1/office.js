...
OSF._OfficeAppFactory = (function OSF__OfficeAppFactory() {
    ...
    var _retrieveHostInfo = function OSF__OfficeAppFactory$_retrieveHostInfo() {
        ...
        if(!hostInfoValue && window.sessionStorage && window.sessionStorage.getItem("hostInfoValue")) {
            hostInfoValue = window.sessionStorage.getItem("hostInfoValue");
        }
        if(hostInfoValue) {
            ...
            if(window.sessionStorage) {
                window.sessionStorage.setItem("hostInfoValue", hostInfoValue);
            }
        } else {
    ...
    var initialize = function OSF__OfficeAppFactory$initialize() {
        ...
        if(_hostInfo.isO15) {
            ...
            _loadScript(basePath + _hostInfo.hostType + "-" + _hostInfo.hostPlatform + "-" + _hostInfo.hostSpecificFileVersion + ".debug.js", loadLocaleStringsAndAppSpecificCode);
        }
