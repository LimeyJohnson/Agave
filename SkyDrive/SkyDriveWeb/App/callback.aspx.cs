namespace SkyDriveWeb.App
{
    ...
    public partial class Callback : System.Web.UI.Page
    {
        ...
        private const string clientId = "000000004C100093";

        // Make sure this is identical to the redirect_uri parameter passed in WL.init() call.
        private const string callback = "https://friendsinoffice.com/skydrive/App/callback.aspx";
        private const string clientSecret = "MFcOV-kbBRc--khO9nwRC0kSkhekjlrl";
