...
Office._MailboxEnums = function () {
  ...
  this.RecipientType = {
    ...
    ///<field type="String">Specifies that the recipient is an SMTP email address that is on the Exchange server that sent the appointment.</field>
    User: "user",
    ///<field type="String">Specifies that the recipient is an SMTP email address that is not on the Exchange server that sent the appointment.</field>
