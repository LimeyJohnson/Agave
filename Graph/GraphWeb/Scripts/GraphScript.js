...
GraphScript.GraphScript.drawChart=function(){var $0=new google.visualization.DataTable();$0.addColumn('string','Toppings');$0.addColumn('number','Slices');$0.addRows([['Mushrooms',1],['Onions',1],['Olives',1],['Zucchini',1],['Pepperoni',2]]);var $1={};$1.title='How Much Pizza I Ate Last Night';$1.width=400;$1.height=300;var $2=new google.visualization.PieChart(document.getElementById('chart_div'));$2.draw($0,$1);}
