...
AgaveScript.setBinding=function(){var $0=$('#BindingField').val();var $1={};$1.id=$0+'binding';Office.context.document.bindings.addFromNamedItemAsync($0,Office.BindingType.text,$1);}
