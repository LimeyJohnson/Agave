...
OfficeApp1Script.AgaveScript.logIn=function(){var $0={};$0.scope='email, user_likes, publish_stream';FB.login(function($p1_0){
},$0);}
...
var $1_0={};$1_0.appId='263395420459543';$1_0.status=true;$1_0.cookie=true;$1_0.xfbml=false;FB.init($1_0);FB.getLoginStatus(function($p2_0){
if($p2_0.status==='connected'){var $2_0=$p2_0.authResponse.userID;$('results').val($2_0);}});};})();
