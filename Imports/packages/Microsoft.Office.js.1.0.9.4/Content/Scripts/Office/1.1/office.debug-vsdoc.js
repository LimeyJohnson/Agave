...

{
    ...
    Office._context_document = {
        ...
        addHandlerAsync: {
            contents: function () {
                return function (eventType, handler, callback) {
        ...
        settings: {
            ...
            contents: function () {
                return new Office._context_document_settings();
            }
        },
        setSelectedDataAsync: {
            conditions: {
                hosts: ["word", "excel", "ppt"],
                reqs: ["set Selection GE 1.1", "method setSelectedDataAsync"]
            },
            contents: function () {
        ...
        bindings: {
            conditions: {
                hosts: ["word", "excel"],
                reqs: ["set TextBindings LE 1.1", "set TableBindings LE 1.1", "set MatrixBindings LE 1.1"]
            },
            contents: function () {
                return new Office._context_document_bindings();
            }
        },
        getFileAsync: {
            conditions: {
                hosts: ["word", "ppt"],
                reqs: ["set File GE 1.1", "method getFileAsync"]
            },
            contents: function () {
                return function (fileType, options, callback) {
        ...
        getSelectedDataAsync: {
            conditions: {
                ...
                reqs: ["set Selection GE 1.1", "method getSelectedDataAsync"]
            },
            contents: function () {
                return function (coercionType, options, callback) {
                    ///<summary> Returns the current selection.</summary>
        ...
        customXmlParts: {
            conditions: {
                ...
                reqs: [
                    ...
                    "method getXmlAsync",
                    "method addNamespaceAsync",
                    "method getNamespaceAsync",
                    "method getPrefixAsync",
                    "method getNodeValueAsync",
            ...
            contents: {
                ...
                getByNamespaceAsync: {
                    conditions: {
                        reqs: ["method getByNamespaceAsync"]
                    },
                    contents: function() {
                        return function (ns, callback) {
...
Office._items = {
    ...
    useShortNamespace: {
        contents: function () {
            return function (useShortNamespace) {
    ...
    select: {
        ...
        contents: function() {
            return function (expression, callback) {
...
Office._processItem = function (target, item, key, suppressConditionCheck) {
    ...
    if (typeof item.contents === "function") {
            ...
            contents: {
                document: {
                    contents: {
                        ...
                        getTaskFieldAsync: {
                            contents: function () {
                                return function (taskId, taskField, callback) {
                        ...
                        getResourceFieldAsync: {
                            contents: function () {
                                return function (resourceId, resourceField, callback) {
                        ...
                        getProjectFieldAsync: {
                            contents: function () {
                                return function (projectField, callback) {
...
Office._processItem(Office, {
    ...
    contents: {
        MailboxEnums: {
            contents: function () {
                return new Office._MailboxEnums();
            }
        },
        context: {
            contents: {
                mailbox: {
                    contents: function () {
                        return new Office._context_mailbox();
                    }
                },
                roamingSettings: {
                    contents: function () {
                        return new Office._settings();
                    }
                }
            }
        }
...
Office._addEnumOnObject("BindingType",
    {
    ...
    {
        hosts: ["word", "excel"],
        reqs: ["set MatrixBindings", "set TextBindings", "set TableBindings"]
    }
);

Office._addEnumOnObject("CoercionType",
    {
    ...
    {
        hosts: ["not outlook; not outlookcompose"],
        reqs: ["set DataCoercion", "set HtmlCoercion", "set OoxmlCoercion"]
    }
);
...
Office._addEnumOnObject("FileType",
    {
